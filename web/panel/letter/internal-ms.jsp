<%-- Panel: Internal examiner appointment letter — Malay language, used by memberPreview.jsp for login-based letter delivery. --%>
<%@ page import="model.VivaAppointment, java.util.Map" pageEncoding="UTF-8" %><%
  ...
  // todayHijri and signerDisplayPhone are required by tmpl-internal-ms.jsp but are not set by memberPreview.jsp
  String todayHijri;
  try {
