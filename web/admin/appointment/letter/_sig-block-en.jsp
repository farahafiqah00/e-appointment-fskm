<%-- English signature block: renders uploaded image as inline base64 or falls back to blank line.
    ...
    try {
      ...
      if (_f.exists()) {
        ...
        out.print("<img src=\"data:" + _m + ";base64," + _b64
            + "\" alt=\"Signature\" style=\"max-height:80px;max-width:220px;display:block;margin-bottom:4px;\">");
        _showImg = true;
      }
