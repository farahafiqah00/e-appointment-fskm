<%-- Letter template fragment: Internal examiner appointment letter in Malay. Included by letterPreview.jsp for admin preview and printing. --%>
...
<%@ include file="_lh-header.jsp" %>
  ...
  <p style="text-decoration:underline;font-weight:bold;">PELANTIKAN SEBAGAI PEMERIKSA DALAMAN TESIS <%= degreeLabelMS.toUpperCase() %></p>
  ...
  <p style="text-align:justify;">2.&nbsp;&nbsp;&nbsp;Sukacita dimaklumkan bahawa, Jawatankuasa Pengajian Siswazah FSKM dalam Mesyuaratnya Kali Ke-23 Bil. 12 Tahun 2025 pada 23 Disember 2025 telah bersetuju untuk melantik YBrs. <%= salutation %> sebagai Pemeriksa Dalaman Tesis bagi pelajar di atas dan <%= honorariumMS %></p>
...
<!-- Lampiran 1 (retired) removed to preserve first-page letter layout -->
