<%-- Letter template fragment: Chairperson appointment letter in Malay. Included by letterPreview.jsp for admin preview and printing. --%>
...
<%@ include file="_lh-header.jsp" %>
  ...
  <p style="text-decoration:underline;font-weight:bold;">PELANTIKAN SEBAGAI PENGERUSI MESYUARAT JAWATANKUASA PEPERIKSAAN TESIS <%= degreeLabelMS.toUpperCase() %></p>
  ...
  <p style="text-align:justify;">2.&nbsp;&nbsp;&nbsp;Sukacita dimaklumkan bahawa, Jawatankuasa Pengurusan Siswazah FSKM telah bersetuju untuk melantik YBrs. <%= salutation %> sebagai Pengerusi Mesyuarat Jawatankuasa Peperiksaan Viva bagi pelajar di atas.</p>

  <p style="text-align:justify;">3.&nbsp;&nbsp;&nbsp;Sehubungan itu, Mesyuarat Jawatankuasa Peperiksaan Viva bagi pelajar di atas dicadangkan pada <strong><%= vivaDayLabel %></strong>. Bersama-sama ini disertakan satu (1) salinan tesis untuk rujukan pihak YBrs. <%= salutation %>. Sila sahkan penerimaan melalui portal FSKM (lihat pratonton surat dalam sistem) atau menggunakan pautan respons selamat yang dihantar ke emel anda sebelum atau pada <strong><%= confirmDeadlineLabel %></strong>.</p>
