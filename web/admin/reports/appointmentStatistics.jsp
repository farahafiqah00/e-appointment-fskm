<%--
  Admin: appointment statistics report — KPI summary, role-frequency table, yearly trends,
  department breakdown, and a per-year appointment detail table, all for a selected year.
--%>
...
<body class="admin">
  ...
  <div class="layout ea-layout">
    <% request.setAttribute("activeSection", "reports"); request.setAttribute("activeSubSection", "reportStats"); %>
      ...
      <div class="ea-main-content-centered d-flex flex-column w-100" style="align-items:stretch;">
        ...
        <div class="w-100 mb-4 p-3 no-print"
          ...
          <form class="row g-2 align-items-center" method="GET"
                action="<%= request.getContextPath() %>/admin/reports/appointments">
            <div class="col-auto">
